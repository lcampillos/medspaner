...
for (i = 1; i < 1000; i++) {
  ...
  s = "try { var " + inner_var + " = document.getElementById('" + inner_var + "'); var " + inner_att_var + " = " + inner_var + ".getAttribute('title'); var " + flat_var + " = document.getElementById('" + flat_var + "'); var " + flat_att_var + " = " + flat_var + ".getAttribute('title'); " + inner_var + ".addEventListener('mouseover', (event) => { " + flat_var + ".setAttribute('title', " + inner_att_var + "); " + inner_var + ".removeAttribute('title'); }); " + inner_var + ".addEventListener('mouseout', (event) => { " + flat_var + ".setAttribute('title'," + flat_att_var + "); " + inner_var + ".setAttribute('title', " + inner_att_var + "); }) } catch (e) { }";
  eval(s);
}
